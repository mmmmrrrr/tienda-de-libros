...
<?php
        ...
        $AccessToken=$objRespuesta->access_token;       //print_r($AccessToken);
        ...
        if($state=="approved"){
            $mensajePaypal="<h3> ¡Pago aprobado! Ya puedes iniciar la descarga. </h3>";
            ...
            $mensajePaypal="<h3> ¡Valió vernón con tu pago ALV! </h3>";
...
<div class="jumbotron">
    ...
    <h1 class="display-4"> ¡Listo compita, ya estuvo! </h1>
    ...
    <p>
        ...
        <div class="row">
            <?php foreach($listaProductos as $producto){ ?>
                <div class="col-3">
                    <div class="card">
                        <img class="card-img-top" src="<?php echo $producto['Imagen']; ?>"  height="210px">
                        <div class="card-body">
